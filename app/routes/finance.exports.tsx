...
export default function FinanceExports() {
  ...
  const recentColumns: Column<ExportLogRow>[] = [
    ...
    },
    {
      ...
      render: (r) => (
        <span className="text-sm/5 text-slate-500 dark:text-slate-400 tabular-nums">
          {r.date_from ? new Date(r.date_from).toLocaleDateString("en-GB") : "ï¿½"}
          {" ? "}
          {r.date_to ? new Date(r.date_to).toLocaleDateString("en-GB") : "ï¿½"}
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      render: (r) => (
        <span className="text-sm/5 text-slate-900 dark:text-slate-100 tabular-nums">
          ï¿½{Number(r.total_amount_gbp).toFixed(2)}
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      render: (r) => (
        <span className="text-sm/5 text-slate-500 dark:text-slate-400 tabular-nums">
          {r.created_at ? new Date(r.created_at).toLocaleString() : "ï¿½"}
        </span>
      ),
    },
  ];
