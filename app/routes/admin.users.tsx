    ...
    <div className="p-6 space-y-6">
      ...
      <form onSubmit={handleSearch} className="flex gap-2">
        <input
          ...
          className="flex-1 px-3 py-2 border border-slate-300 dark:border-slate-600 dark:border-slate-600 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        <button
          type="submit"
                ...
                <div className="flex gap-2">
                  ...
                  <Form method="post" className="inline-flex items-center gap-1">
                    ...
                    <select
                      ...
                      className="px-2 py-1 border border-slate-300 dark:border-slate-600 dark:border-slate-600 rounded text-xs focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                      <option value="passenger">Passenger</option>
                      <option value="operations">Operations</option>
                      <option value="pilot">Pilot</option>
